...
class DGM_PT_main_panel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if scene.dgm_show_export:
            ...
            # Textures path — only shown when selections are marked for baking
            ...
            # Scripts path — only shown when door axis points exist in Memory LOD
...
def register_scene_props():
    ...
    S.dgm_show_export      = bpy.props.BoolProperty(default=True)
    ...
    S.dgm_export_container_base = bpy.props.BoolProperty(
        ...
        description="Export container base config.cpp and 4_World scripts alongside the P3D",
    )
...
def unregister_scene_props():
    ...
    props = [
        "dgm_target_object",
        "dgm_show_fire", "dgm_show_memory", "dgm_show_lods", "dgm_show_export", "dgm_cta_baking_open",
        "dgm_fire_quality",
